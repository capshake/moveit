                    ...
                    <div class="well">
                        <form method="POST" action="<?php echo BASEDIR; ?>admin/rooms/create" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <select id="room_map_id" class="form-control" name="room_map_id">
                                    <?php
                                    $maps = $db->query("SELECT map_id, map_building_id, map_floor, map_picture, map_scale_cm, map_scale_px, building_name, building_type FROM " . TABLE_MAPS . " LEFT JOIN " . TABLE_BUILDINGS . " ON map_building_id = building_id ORDER BY map_id");
                                    foreach ($maps as $map) {
